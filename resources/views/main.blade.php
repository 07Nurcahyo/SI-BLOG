...
<nav class="navbar navbar-expand-lg">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex">
        <button type="button" class="btn btn-success rounded-3" data-bs-toggle="modal" data-bs-target="#exampleModal">Login admin
          <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-person logoadmin" viewBox="0 0 16 16">
